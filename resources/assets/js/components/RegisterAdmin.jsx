...
import { registerAdmin } from "../action/authenticateAction";
...
handleSubmit(event) {
    ...
    this.props.registerAdmin(this.state)    
    this.setState(
      { 
        name: '', email: '', password: '', password_confirmation: '', 
        telephone: '',  sex: '', date_of_birth: '' 
            ...
            <div className="container">
                <form className="form-horizontal"  method="POST" onSubmit={this.handleSubmit}>
                  <fieldset>
                    ...
                    <div id="legend">
                      <legend className="">Регистрация для админов</legend>
                    </div>
...
function mapDispatchToProps(dispatch) {
  return {
        registerAdmin: (user) => {
            dispatch(registerAdmin(user)); //1)store.dispatch 
        },
  }
}
